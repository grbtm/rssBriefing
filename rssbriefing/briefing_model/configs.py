...
reference_feeds = [
    ...
    'International homepage', # FT - PROBLEM: DUPLICATED POSTS (e.g. 'Paris, Texas offers a cautionary tale on reopening America')
    ...
    'World News - Breaking News, Top Stories', # Huffington Post; 1 sentence headline, 1 sentence description TODO remove 'Coronavirus Live Updates':
